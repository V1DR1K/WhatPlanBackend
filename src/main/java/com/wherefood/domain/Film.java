...
public class Film {
 ...
 @Column(unique = true) public Long tmdbId;
 ...
 @ElementCollection @CollectionTable(name = "film_genres", joinColumns = @JoinColumn(name = "film_id")) @Column(name = "name") public Set<String> genres = new LinkedHashSet<>();
